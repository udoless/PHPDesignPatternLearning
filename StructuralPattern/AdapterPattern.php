<?php
/**
 * Created by Haozhong.Liu on 12/29/15 11:25.
...
class AdapterA extends AdapteeA implements TargetA { // 适配后角色
    public function sampleMethod2() {}
}
...
class AdapterB implements TargetB {
    private $_adaptee;
    public function __construct(AdapteeB $adaptee) {
...
$adaptee = new AdapteeB();
$adapter = new AdapterB($adaptee);
$adapter->sampleMethod1();
$adapter->sampleMethod2();