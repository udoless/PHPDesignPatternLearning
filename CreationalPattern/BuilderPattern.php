<?php
/**
 * Created by Haozhong.Liu on 12/29/15 11:11.
...
var_dump($product);  //before build
$director = new Director($buidler);
var_dump($product);  //after build

/*
 * Output:
 *
 * object(PHPDesignPattern\CreationalPattern\BuilderPattern\Product)#2 (1) { ["_parts":"PHPDesignPattern\CreationalPattern\BuilderPattern\Product":private]=> array(0) { } }
 * object(PHPDesignPattern\CreationalPattern\BuilderPattern\Product)#2 (1) { ["_parts":"PHPDesignPattern\CreationalPattern\BuilderPattern\Product":private]=> array(2) { [0]=> string(5) "Part1" [1]=> string(5) "Part2" } }
 */
?>